...
%%
aperture = 150;
minDist = [300,300, 280, 240, 300, 220, 1000, 900, 850];
bestAxis = [5,4,6,1,2,3,3,3,3]; %the best axis to use from the data to find endpoints
startClipping = [200, 400, 360, 1, 300, 660, 1, 1, 1];%array for removing front endpoints of each motion of its best axis 
endClipping = [500, 200, 200, 420, 500, 550, 1, 1, 2500];% array for removing endpoints for this point for each motion of its best axis 
