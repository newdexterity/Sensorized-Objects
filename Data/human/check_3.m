...
%%
aperture = 150;
minDist = [1200,300, 280, 240, 250, 220, 250];
bestAxis = [5,5,6,1,2,3]; %the best axis to use from the data to find endpoints
startClipping = [3000, 600, 150, 100, 340, 400, 1];%array for removing front endpoints of each motion of its best axis 
