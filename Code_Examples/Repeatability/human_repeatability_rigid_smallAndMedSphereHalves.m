...
startClipping = [750];%array for removing front endpoints of each motion of its best axis 
endClipping = [500];% array for removing endpoints for this point for each motion of its best axis 
