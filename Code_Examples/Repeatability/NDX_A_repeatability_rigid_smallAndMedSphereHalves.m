...
minDist = [1200];
bestAxis = [5]; %the best axis to use from the data to find endpoints
startClipping = [3000];%array for removing front endpoints of each motion of its best axis 
endClipping = [2000];% array for removing endpoints for this point for each motion of its best axis 
