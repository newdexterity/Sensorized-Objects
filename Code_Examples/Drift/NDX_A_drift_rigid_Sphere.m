...
minDist = [300,2000,2500];%distance between the peaks 
bestAxis = [1,2,4]; %the best axis to use from the data to find endpoints
startCycle = [3,2,2]; %starting cycles
endCycle = [0,1,0]; %cycle points to remove from the end
