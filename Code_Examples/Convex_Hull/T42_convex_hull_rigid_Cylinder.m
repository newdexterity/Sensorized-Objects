...
%      This is a script to Visualize and calculate the convex hull trajectories of the T42 inhand
%      manipulation with a rigid cylinder. 
%% File Setup
clc;
clear all;
close all;
%% defining file name structure e.g. "hand_object_motion"
hand = 'T42';
object = 'cylinder';
...
%title('Convex Hull of Positional Component of NDX Hand Manipulation with Cylinder')
xlabel('x [mm]')
ylabel('y [mm]')
zlabel('z [mm]')
...
hold on 
trisurf(tr,'facecolor',[0 0.4470 0.7410],'facealpha', 0.15, 'edgecolor', [0 0.4470 0.8410],'LineWidth', 0.9)
%title('Convex Hull of rotational Component of NDX Hand Manipulation with Cylinder')
xlabel('Rx [deg]')
ylabel('Ry [deg]')
zlabel('Rz [deg]')
